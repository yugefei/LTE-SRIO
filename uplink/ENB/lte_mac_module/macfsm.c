...
static void test_get_pkt_num()
{
	FIN(test_get_pkt_num());
	SV_PTR_GET(mac_sv);
	printk("[ENBMAC]lost_pktnum_uplink:%d\n",SV(lost_pktnum_uplink));
	printk("[ENBMAC]total_pktnum_uplink:%d\n",SV(total_pktnum_uplink));
	printk("[ENBMAC]lost_pktnum_downlink:%d\n",SV(lost_pktnum_downlink));
	printk("[ENBMAC]total_pktnum_downlink:%d\n",SV(total_pktnum_downlink));
	FOUT;
}
/************************************************************************
*author:LHL
