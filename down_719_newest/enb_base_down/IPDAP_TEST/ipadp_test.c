...
#include "./ipadp_test.h" 

//ipadptest -s LTE_IPADP0
//ipadptest -r LTE_IPADP0
//ipadptest -i LTE_IPADP0 xxxxx
...
void usage(void)
{
	const char* info_ptr = "ipadptest -s LTE_IPADP0   \
			  	\nipadptest -r LTE_IPADP0 \
			  	\nipadptest -i LTE_IPADP0 xxxxx (seconds)\n";
	printf(info_ptr);
}
